...
public class YelpAPI {
    ...
    private static final String CONSUMER_KEY = "xLxVLrvd9CY7x0IDrffdLg";
    private static final String CONSUMER_SECRET = "HewBBvtzflKF88gqI_RCV6SqFdw";
    private static final String TOKEN = "6ToXfCrkh0RSkSI_cCrwJO7skmcysmji";
    private static final String TOKEN_SECRET = "lcXdLy8QVNeKPNkBoemOmhXL_vI";
